...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{openscad_screenshot_1.png}
    \hfill
    \includegraphics[width=0.45\textwidth]{openscad_screenshot_2.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{openscad_screenshot_5.png}
    \hfill
    \includegraphics[width=0.3\textwidth]{openscad_screenshot_6.png}
    \hfill
    \includegraphics[width=0.3\textwidth]{openscad_screenshot_7.png}
    \caption{Detalles constructivos en OpenSCAD: chavetero horn lock (izquierda), cuna del servo de rodilla en fémur (centro) y acople de articulación en la pata (derecha).}
    \label{fig:detalles_tolerancia_scad}
\end{figure}
...
Los picos de corriente transitorios que ocurren al iniciar la marcha del cuadrúpedo pueden generar caídas bruscas en la tensión lógicas de alimentación (\textit{brownouts}), reiniciando la ESP32. Para evitar esto, se utiliza un regulador \textbf{UBEC (5V/3A)} externo. Su salida se conecta directamente a la bornera de alimentación del PCA9685, aislando la corriente de los servos. Es fundamental unificar todas las referencias \textbf{GND} en un nodo común para evitar deriva de voltaje y lectura corrupta en la IMU y los servos.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{openscad_screenshot_8.png}
