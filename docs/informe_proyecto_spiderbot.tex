...
Vin & LM2596 \#2 Out (5.0V) & Alimentación & Tensión de entrada regulada para ESP32 \\
...
\begin{itemize}
    \item \textbf{LM2596 \#1 (regulado a 6.0V):} Alimenta exclusivamente el riel de potencia de los 8 servomotores SG90/MG90S, proporcionando el margen de voltaje necesario para mantener el torque bajo carga sin interferir con la lógica de control.
