...
\begin{frame}{Arquitectura Electrónica y Conexiones}
    \begin{columns}
        ...
        \begin{column}{0.52\textwidth}
            \begin{alertblock}{Alimentación y Potencia (UBEC)}
                \begin{itemize}
                    \item \textbf{Baterías 2S 14500 (7.4V):} 2 celdas de litio recargables en serie en la parte inferior del chasis.
                    \item \textbf{UBEC (5V/3A):} Regulador step-down que reduce la tensión a 5V regulados de forma eficiente.
                    \item \textbf{Aislamiento Lógico:} Separa la línea de fuerza de los servos de la ESP32 para evitar caídas (*brownouts*).
