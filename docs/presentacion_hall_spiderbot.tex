...
% Slide 3b: Capturas de OpenSCAD
\begin{frame}{Modelado CAD y Tolerancias (Detalles de OpenSCAD)}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=2.3cm]{openscad_screenshot_1.png}
                \\ \vspace{0.1cm}
                \scriptsize\color{USSBlue}\textit{Placas base superior e inferior del chasis}
            \end{center}
            \begin{center}
                \includegraphics[height=2.3cm]{openscad_screenshot_3.png}
                \\ \vspace{0.1cm}
                \scriptsize\color{USSBlue}\textit{Diseño paramétrico del eslabón fémur}
            \end{center}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=2.3cm]{openscad_screenshot_5.png}
                \\ \vspace{0.1cm}
                \scriptsize\color{USSBlue}\textit{Chavetero de bloqueo Single-Arm Horn Lock}
            \end{center}
            \begin{center}
                \includegraphics[height=2.3cm]{openscad_screenshot_7.png}
                \\ \vspace{0.1cm}
                \scriptsize\color{USSBlue}\textit{Acople de articulación cadera-fémur}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Ensamblaje General del Cuadrúpedo en OpenSCAD}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[width=0.95\textwidth]{openscad_screenshot_8.png}
                \\ \vspace{0.1cm}
