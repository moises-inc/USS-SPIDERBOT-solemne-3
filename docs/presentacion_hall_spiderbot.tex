    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{block}{Bus I2C y Señales PWM}
                ...
                \begin{enumerate}
                    ...
                    \item \textbf{8x Servos PWM:} Control de posición directo por GPIOs (13, 12, 15, 2, 4, 5, 23, 25).
                \end{enumerate}
            \end{block}
        \end{column}
        ...
        \begin{alertblock}{Alimentación Dual Independiente (LM2596)}
            \begin{itemize}
                ...
                \item \textbf{LM2596 \#1 (6.0V servos):} Regulador step-down que alimenta el riel de potencia de los 8 servos SG90/MG90S.
