...
\begin{frame}{Modelado CAD --- Placa Base Inferior}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=5.2cm]{openscad_screenshot_6.png}
                \\ \vspace{0.1cm}
...
\begin{frame}{Modelado CAD --- Placa Base Superior}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=5.2cm]{openscad_screenshot_4.png}
                \\ \vspace{0.1cm}
...
\begin{frame}{Modelado CAD --- Eslabón Fémur}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=5.2cm]{openscad_screenshot_8.png}
                \\ \vspace{0.1cm}
...
\begin{frame}{Modelado CAD --- Tibia Articulada}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=5.2cm]{openscad_screenshot_3.png}
                \\ \vspace{0.1cm}
